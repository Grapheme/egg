...
<html lang="en-us">
  ...
  <body class="">
      ...
      <nav>
        ...
        <ul>
          ...
          <li <?php if(slink::segment(2) == 'pages') echo "class=\"active\"";?>>
            <a href="<?=URL::to('admin/pages')?>" title="Dashboard"><i class="fa fa-lg fa-fw fa-list-alt"></i> <span class="menu-item-parent">Pages</span></a>
          </li>
        </ul>
      </nav>
    ...
    <!-- CUSTOM NOTIFICATION -->
    <script src="<?=URL::to('public/admin_template/js/notification/SmartNotification.min.js')?>"></script>
